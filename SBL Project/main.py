...
def startGame():
	global running, game_page, total_bullets_shot, home_page, score_page, score, sound_on, start_time, level, plane_destroy_count, moving_left, moving_right, type, total_planes_shot, temp2b, temp1b
	while running:
		for event in pygame.event.get():
			...
			if event.type == pygame.KEYDOWN and game_page:
				...
				if event.key == pygame.K_SPACE:
					shoot_bullet()
					total_bullets_shot = total_bullets_shot + 1
		...
		if score_page:
			...
			final_score_msg.update(total_planes_shot)
		...
		if game_page:
			...
			if p.alive:
				...
				for bullet in player_bullet_group:
					...
					for plane in planes_hit:
						...
						if plane.health <= 0 and temp1b and temp2b:
							total_planes_shot += 1
							temp1b = False
							temp2b = False
						elif not temp2b:
			...
			score_msg.update(total_planes_shot)
...
print("Hello And Welcome To AreoBlaster Game\n")
profile_name = input("Please Enter Your Name : ")
...
while(wanna_play):
	...
	startGame()
	print("You Scored : " + str(total_planes_shot))

	play_again = input("Wanna Play Again (y/n): ")
	if play_again.lower() != "y" and play_again.lower() != "yes" and play_again.lower() != "ya":
		wanna_play = False
